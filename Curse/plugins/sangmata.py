...
async def handle_sangmata_toggle(self: Client, cq: CallbackQuery):
    ...
    if not cq.message.chat:
        return await cq.answer("⚠️ This action must be used in a group.", show_alert=True)
